...
if(anps_header_media(get_the_ID(), "blog-grid")!="") {
	...
	$post_data .= "<span>".get_the_date()."</span> / <span>".get_comments_number()." ".__("comments", ANPS_TEMPLATE_LANG)."</span>";
	$post_data .= "</header>";
	...
	$post_data .= "<span>".get_the_date("j / m / Y")."</span> / <span>".get_comments_number()." ".__("comments", ANPS_TEMPLATE_LANG)."</span>";
	$post_data .= "</header>";
    $post_data .= "<div class='post-content'>".$content_text."</div>"; 
    $post_data .= "</div>";
}
