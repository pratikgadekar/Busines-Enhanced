...
function anps_widgets_init() {
    ...
    if ($above_nav_bar=='1') { 
        register_sidebar(array(
            'name' => __('Above navigation bar', ANPS_TEMPLATE_LANG),
            'id' => 'above-navigation-bar',
            'description' => __('This is a bar above main navigation. Can only contain Text, Search, Custom menu and WPML Languge selector widgets', ANPS_TEMPLATE_LANG),
            'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
            'after_widget' => '</li>',
            'before_title' => '<h3 class="widget-title">',
            'after_title' => '</h3>',
    ...
    if($prefooter=="on") {
        ...
        if($prefooter_columns=='2' || $prefooter_columns=='5' || $prefooter_columns=='6') {
            register_sidebar(array(
                'name' => __('Prefooter column 1', ANPS_TEMPLATE_LANG),
                'id' => 'prefooter-1',
                'description' => __('This wiget area displays before footer. For more information and to set different number of widget areas, please check "Theme options" -> "Page setup".', ANPS_TEMPLATE_LANG),
                'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
                'after_widget' => '</li>',
                'before_title' => '<h3 class="widget-title">',
                'after_title' => '</h3>',
            ...
            register_sidebar(array(
                'name' => __('Prefooter column 2', ANPS_TEMPLATE_LANG),
                'id' => 'prefooter-2',
                'description' => __('This wiget area displays before footer. For more information and to set different number of widget areas, please check "Theme options" -> "Page setup".', ANPS_TEMPLATE_LANG),
                'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
                'after_widget' => '</li>',
            ...
            register_sidebar(array(
                'name' => __('Prefooter column 3', ANPS_TEMPLATE_LANG),
                'id' => 'prefooter-3',
                'description' => __('This wiget area displays before footer. For more information and to set different number of widget areas, please check "Theme options" -> "Page setup".', ANPS_TEMPLATE_LANG),
                'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
                'after_widget' => '</li>',
            ...
            register_sidebar(array(
                'name' => __('Prefooter column 4', ANPS_TEMPLATE_LANG),
                'id' => 'prefooter-4',
                'description' => __('This wiget area displays before footer. For more information and to set different number of widget areas, please check "Theme options" -> "Page setup".', ANPS_TEMPLATE_LANG),
                'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
                'after_widget' => '</li>',
    ...
    if($footer_columns=='2') {
        register_sidebar(array(
            'name' => __('Footer column 1', ANPS_TEMPLATE_LANG),
            'id' => 'footer-1',
            'description' => __('This wiget area displays in footer. For more information and to set different number of widget areas, please check "Theme options" -> "Page setup".', ANPS_TEMPLATE_LANG),
            'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
            'after_widget' => '</li>',
            'before_title' => '<h3 class="widget-title">',
            'after_title' => '</h3>',
        ...
        register_sidebar(array(
            'name' => __('Footer column 2', ANPS_TEMPLATE_LANG),
            'id' => 'footer-2',
            'description' => __('This wiget area displays in footer. For more information and to set different number of widget areas, please check "Theme options" -> "Page setup".', ANPS_TEMPLATE_LANG),
            'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
            'after_widget' => '</li>',
        ...
        register_sidebar(array(
            'name' => __('Footer column 3', ANPS_TEMPLATE_LANG),
            'id' => 'footer-3',
            'description' => __('This wiget area displays in footer. For more information and to set different number of widget areas, please check "Theme options" -> "Page setup".', ANPS_TEMPLATE_LANG),
            'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
            'after_widget' => '</li>',
        ...
        register_sidebar(array(
            'name' => __('Footer column 4', ANPS_TEMPLATE_LANG),
            'id' => 'footer-4',
            'description' => __('This wiget area displays in footer. For more information and to set different number of widget areas, please check "Theme options" -> "Page setup".', ANPS_TEMPLATE_LANG),
            'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
            'after_widget' => '</li>',
    ...
    if($copyright_footer=="1" || $copyright_footer=="0") {
        register_sidebar(array(
            'name' => __('Copyright footer column 1', ANPS_TEMPLATE_LANG),
            'id' => 'copyright-1',
            'description' => __('This wiget area displays below all content in footer. For more information and to set different number of widget areas, please check "Theme options" -> "Page setup".', ANPS_TEMPLATE_LANG),
            'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
            'after_widget' => '</li>',
            'before_title' => '<h3 class="widget-title">',
            'after_title' => '</h3>',
        ...
        register_sidebar(array(
            'name' => __('Copyright footer column 2', ANPS_TEMPLATE_LANG),
            'id' => 'copyright-2',
            'description' => __('This wiget area displays below all content in footer. For more information and to set different number of widget areas, please check "Theme options" -> "Page setup".', ANPS_TEMPLATE_LANG),
            'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
            'after_widget' => '</li>',
