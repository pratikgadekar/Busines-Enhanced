...
.transparent.top-bar, .transparent.top-bar a, .above-nav-bar.top-bar a, .above-nav-bar.top-bar a, header.site-header nav div.top-bar.above-nav-bar div ul li.widget-container a, header.site-header nav div.top-bar.above-nav-bar div ul li.widget-container
{color:<?php echo esc_attr($top_bar_color); ?>;}
header.site-header nav div.top-bar.above-nav-bar div ul li.widget-container span:not(.fa)
 {color:<?php echo esc_attr($hover_color); ?>!important;}   
.transparent.top-bar a:hover, .paralax-header > .page-heading ul.breadcrumbs a:hover, .paralax-header .site-navigation > ul > li.menu-item > a:hover, .above-nav-bar.top-bar a:hover, header.site-header nav div.top-bar.above-nav-bar div ul li.widget-container a:hover
 {color:<?php echo esc_attr($hover_color); ?>;}   

.paralax-header nav.site-navigation > ul > li.current_page_item > a::after, .paralax-header nav.site-navigation > ul > li:hover > a::after, .paralax-header nav.site-navigation > ul > li.current-menu-parent > a::after 
...
function anps_get_logo() { 
    ...
    <?php else: ?>
        <a href="<?php echo esc_url(home_url("/")); ?>"><img style="width: <?php echo esc_attr($logo_width); ?>; height: <?php echo esc_attr($logo_height); ?>px" alt="Site logo" src="http://astudio.si/accounting/wp-content/uploads/2015/04/logo-primary.png"></a>        
    <?php endif;
    endif;
}
/* Tags and author */
...
?>
    ...
    ?>
    <?php if( ($above_nav_bar == '1') && (is_active_sidebar( 'above-navigation-bar'))) : ?>
