...
if(is_sticky(get_the_ID())) {
    ...
    $post_data .= "<ul>";
    $post_data .= "<li><i class='hovercolor fa fa-comment-o'></i><a href='".get_permalink()."#comments'>".get_comments_number()." ".__("comments", ANPS_TEMPLATE_LANG)."</a></li>";
    ...
    $post_data .= "</li>";
    $post_data .= "<li><i class='hovercolor fa fa-user'></i>".__("posted by", ANPS_TEMPLATE_LANG)." <a href='".get_author_posts_url(get_the_author_meta('ID'))."' class='author'>".get_the_author()."</a></li>";
    ...
    $post_data .= '<a class="btn btn-sm style-4" href="'.get_permalink().'">'.__("Read more", ANPS_TEMPLATE_LANG).'</a>';
